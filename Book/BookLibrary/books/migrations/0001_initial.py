    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('author', models.ManyToManyField(help_text='Select Author name', to='books.Author')),
            ],
        ),
        migrations.CreateModel(
            name='BookInstance',
        ...
        migrations.AddField(
            model_name='book',
            name='currency',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='books.Currency'),
        ),
    ]
